...
Analisis *Gene Ontology* (GO) dan *Kyoto Encyclopedia of Genes and Genomes* (KEGG) (Gambar 4) serta visualisasi *pathway* (Gambar 3) secara komprehensif memvalidasi mekanisme di atas. Bukti klinis paling konklusif dari identifikasi target ini adalah berhinggapnya gen-gen sentral secara langsung pada ***Inflammatory bowel disease (IBD) pathway***. Sebagai payung utama dari penyakit Kolitis Ulserativa, kemunculan *pathway* IBD ini memvalidasi secara *in silico* bahwa intervensi molekuler dari kelima senyawa tersebut tidak melenceng, melainkan secara presisi membidik akar patologi penyakit. 

Sejalan dengan teraktivasinya jalur IBD, hasil pengayaan dengan nilai signifikansi yang sangat tinggi (FDR sangat rendah $\approx 6.0 \times 10^{-12}$) dan ukuran *Gene Count* yang besar juga terpusat pada ***TNF signaling pathway*** dan ***NF-kappa B signaling pathway***. Modulasi paralel pada jalur penyakit IBD dan jalur inflamasi ini membuktikan secara molekuler terhentinya kaskade pelepasan kemokin yang menjadi penyebab utama kerusakan jaringan kolon pada pasien UC.

Lebih jauh, analisis mengungkap keterlibatan jalur sistem pertahanan inang, yakni ***Toll-like receptor (TLR) signaling pathway*** dan ***T cell receptor signaling pathway***. Patogenesis UC sering kali dipicu oleh disfungsi sistem imun dalam merespons mikrobiota usus normal (*dysbiosis*). **TLR9** (salah satu *hub gene* peringkat 8) berperan mengenali pola molekuler patogen; jika teraktivasi abnormal, ia memicu makrofag merilis TNF. Di saat yang sama, aktivasi reseptor sel T yang diregulasi oleh enzim kinase spesifik seperti **LCK, JAK1,** dan **SYK** memicu autoimunitas di mukosa usus. Pengikatan kelima senyawa pada reseptor imun dan kinase ini mengindikasikan adanya efek **imunomodulatori**, yakni menenangkan hipersensitivitas sistem imun mukosa agar tidak merusak jaringan epitel ususnya sendiri.
